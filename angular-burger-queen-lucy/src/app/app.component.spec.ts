...
describe('AppComponent', () => {
  ...
  it('should create the app', async(() => {
    //linea 17 veremos que utiliza una función “it”, que casualmente en su primer parámetro recibe el texto que imprimo nuestro test, y luego recibe una función que genera un “async” con el contenido que testea una “funcionalidad” de nuestro componente
  ...
  it(`should have as title 'angular-burger-queen-lucy'`, () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.debugElement.componentInstance;
    expect(app.title).toEqual('BIENVENIDOS BURGER QUEEN INICIA TU PEDIDO!!');
  });
  ...
  it('should render title in a h1 tag', () => {
    ...
    expect(compiled.querySelector('h1').textContent).toContain(
      'BIENVENIDOS BURGER QUEEN INICIA TU PEDIDO!!'
    );
  });
});
